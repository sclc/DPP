...
// AOS: 01 02 03 11 12 13 21 22 23 31 32 33
//
...
soa2aos(float *xyz)
{
    __m128 x = _mm_load_ps(xyz+0);
    __m128 y = _mm_load_ps(xyz+4);
    __m128 z = _mm_load_ps(xyz+8);
    ...
    _mm_store_ps(xyz+0, rx0y0z0x1);
    _mm_store_ps(xyz+4, ry1z1x2y2);
    _mm_store_ps(xyz+8, rz2x3y3z3);
